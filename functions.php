...
function listcategory($list,$class,$icons)
{
	foreach ($list as $key => $cat) {
			$category=get_category_by_slug($cat);
			if($category):
			echo "<li>";
				echo '<a class="'.$class.'" href="' . get_category_link( $category->term_id ) . '" title="' . sprintf( __( "View all posts in %s" ), $category->name ) . '" ><span data-icon="'.$icons[$key].'"> </span>' . $category->name.'</a>';
			echo "</li>";
			endif;
		}	
}
